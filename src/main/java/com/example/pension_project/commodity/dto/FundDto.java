...
public class FundDto {
    ...
    private Double oneMonth; // MN1_JBEF_ENRT; //1개월 수익률
    private Double threeMonth; //MN3_JBEF_ENRT; //3개월 수익률
    private Double sixMonth; //MN6_JBEF_ENRT; //6개월 수익률
    private Double year; //YR1_JBEF_ENRT; //1년 수익률
