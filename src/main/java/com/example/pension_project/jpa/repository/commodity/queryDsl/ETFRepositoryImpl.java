...
public class ETFRepositoryImpl implements FundCustomRepository<ETFEntity> {
    ...
    @Override
    public PagenationDto<ETFEntity> findAllWithCondition(BooleanBuilder builder, NumberPath<Double> sortedField, Pageable pageable) {
        List<ETFEntity> list = jpaQueryFactory
		...
		return new PagenationDto<ETFEntity>(totalCnt, list);
    }
}
